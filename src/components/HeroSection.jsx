    ...
    return (
        <div className='bg-about-bg w-screen h-auto pt-20 md:pt-44 lg:pt-44 xl:pt-44 pb-20  overflow-hidden '>
            <div className="w-screen   h-full mx-auto overflow-hidden">
                <div className="max-w-7xl mx-auto  h-full grid lg:grid-cols-2 md:grid-cols-2  gap-4 overflow-hidden flex justify-between" >
                    ...
                    <div className="text-white  h-auto px-8 text-center md:text-left lg:text-left overflow-hidden">
                        ...
                        <div className=' py-6'>
                            <a href="https://www.github.com/felabel" className="bg-github px-8  py-4 mr-2 rounded-full my-6 font-semibold tracking-wide block md:inline-block md:inline-block ">
                    ...
                    <div className="pic  h-full  md:block xl:block lg:block pb-10 mx-auto">
                        <div class=" center text-2xl my-auto mx-auto ">
                        <h2 className="text-purple text-3xl font-bold uppercase pt-2">My Services</h2>
                            <ul className="text-gray-100 font-bold capitalize">
                                ...
                                <a href="tel:+2349063843098" className="bg-teal px-10 py-2  mt-4 rounded-full text-gray-100">
                                    +2349063843098
                                </a>
                            </ul>
                        </div>
